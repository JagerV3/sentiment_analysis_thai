...
class Thai_sentiment():
    ...
    model.save("./model/thaitext-classifier-combined_inhousedata-UTF8-4-100.tfl")
    print("Network trained and saved as thaitext-classifier-combined_inhousedata-UTF8-4-100.tfl")
